...
class UserProjectsControllerTest < ActionController::TestCase
  ...
  test "should create user_project" do
    assert_difference('UserProject.count') do
      post :create, user_project: { project_id: @user_project.project_id, user_belongs_to: @user_project.user_belongs_to }
    end
  ...
  test "should update user_project" do
    patch :update, id: @user_project, user_project: { project_id: @user_project.project_id, user_belongs_to: @user_project.user_belongs_to }
    assert_redirected_to user_project_path(assigns(:user_project))
  end
