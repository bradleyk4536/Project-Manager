class UserProjectsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
			format.html { redirect_to users_tenant_project_url(id: @user_project.project.project_id),
				tenant_id: @user_project.tenant_id, notice: 'User successfully removed from project ' }
  ...
  private
    ...
    def user_project_params
      params.require(:user_project).permit(:project_id, :user_belongs_to)
    end
end
